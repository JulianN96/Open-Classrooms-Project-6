...
export default function TopBanner() {
  ...
  const [homeClassNames, setHomeClassNames] = useState('active')
  const [aboutClassNames, setAboutClassNames] = useState('active')
  const currentLocation = useLocation().pathname;
  useEffect(() => {
    console.log(currentLocation)
    if (currentLocation === '/') {   
      setHomeClassNames('banner__navHome banner__nav--active')
      setAboutClassNames('banner__navAbout') 
    } else if (currentLocation === '/about') {
      console.log('aboot');
      setHomeClassNames('banner__navHome')
      setAboutClassNames('banner__navAbout banner__nav--active') 
    } else if(currentLocation !== '/about' | '/'){
      setHomeClassNames('banner__navHome')
      setAboutClassNames('banner__navAbout') 
    }
    ...
    <div>
      <div className='banner'>
        ...
        <nav className='banner__nav'>
          ...
          <Link className={aboutClassNames} to='/about'>
            A Propos
          </Link>
        </nav>
      </div>
