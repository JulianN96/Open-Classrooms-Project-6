    ...
    <div className='about'>
      ...
      <div className='aboutInfo__container'>
        <article className='aboutInfo__dropdown'>
          <div className='aboutInfo__dropdownBar'>
            <h2 className='aboutInfo__dropdownBarTitle'>Fiabilité</h2>
            <svg className='aboutInfo__dropdownBarArrow' xmlns="http://www.w3.org/2000/svg" width="33" height="32" viewBox="0 0 33 32" fill="none">
          ...
          <div className='aboutInfo__dropdownInfoContainer'><p className='aboutInfo__dropdownInfoText'>Les annonces postées sur Kasa garantissent une fiabilité totale. Les photos sont conformes aux logements, et toutes les informations sont régulièrement vérifiées par nos équipes.</p></div>
        </article>
        <article className='aboutInfo__dropdown'>
          <div className='aboutInfo__dropdownBar'>
          ...
          <div className='aboutInfo__dropdownInfoContainer'><p className='aboutInfo__dropdownInfoText'>La bienveillance fait partie des valeurs fondatrices de Kasa. Tout comportement discriminatoire ou de perturbation du voisinage entraînera une exclusion de notre plateforme.</p></div>
        </article>
        <article className='aboutInfo__dropdown'>
          <div className='aboutInfo__dropdownBar'>
